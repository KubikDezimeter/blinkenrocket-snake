...
CXXFILES = src/main.cpp src/Animation.cpp src/ButtonHandler.cpp src/HardwareDisplay.cpp src/Frame.cpp src/Coordinates.cpp src/Random.cpp src/SignalRenderer.cpp src/Snake.cpp src/SnakeGame.cpp src/Time.cpp src/Vector.cpp
